          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <div className="hidden md:ml-6 md:flex md:space-x-8">
                ...
                <Link href="/admin/articles" className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                  Articles
                </Link>
            ...
            <div className="flex items-center">
              {session?.user?.name && <span className="text-gray-700 mr-4 text-sm">Logged in as {session.user.name}</span>}
              <button
